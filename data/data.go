...
func init() {
	...
	if dataLength = len(Data); dataLength == 0 {
		panic("no data")
	}
}
...
你总会遇到一个人，恰如其分的适合你，不用刻意迁就，任意撒娇，你们相爱，并且默契。
...
既然选择了远方，便只顾风雨兼程。
少小离家老大回，乡音无改鬓毛衰。
一旬败给年少轻狂的理想，二旬败给青涩无知的爱情，三旬败给沧桑寂寥的现实。
近水楼台先得月，向阳花木易为春。
...
一定没有问题的！
人与人的相遇，不是恩赐就是劫。
就此分别吧！请继续向前，迎接樱花漫溢的四月，但请不要忘记我，友人 A……
现在得到的将来定将十倍失去
...
一懒众衫小
人生没有定数的，社会不会抛弃努力的人，只要努力，人生都会慷慨地馈赠让你满意的礼物！
...
布加迪威龙是世界上量产最快的跑车，但他跑不过时光，更跑不过早已注定好的命运。
今人不见古时月，今月曾经照古人。
弱小不是逃避的借口，应是竭尽全力的理由。
...
我和空太是恋人以上，友人未满的关系。
如果有人对我说抱有希望是错误的花，我会无数次回答不是这样的，无论什么时候都一定会这样撑下去。
明月出天山，苍茫云海间。
绝对封锁带来绝对泛滥。
...
再相见，会是怎样的世界？
有时候解释是不必要的，因为往往他们不信你的解释，或者无需你的解释。
既然不能让对手变弱，那就让自己变强！
我是想被包养，但不会接受施舍
雨，打湿了窗，打湿了行人，打湿了梦境。
别错把工具当成目的。
...
那些自以为看透局势的人，往往只是看到了布局者希望他看到的东西。
跑得快不一定赢，不跌跟头才是成功
...
如果你是魔女，我只要化身魔王就可以了。
在该拒绝时会拒绝，是能力；在不该拒绝时不拒绝，是智慧；清楚什么时候该拒绝、什么时候不该拒绝，是成熟。
我只是做了我能做的事，没有时间想将来。
...
你特殊的遭遇并不是你可以特殊的理由
不相信人咬不到肚脐的，咬破肚脐去死如何？
请热爱这个世界，哪怕它是冷的；请保持一颗火热的心，因为我们脚下的星球，她的心也是热的。
行到水穷处，坐看云起时。
...
开始的倾心交谈，沦为平淡。
我总在这里等着，你不过来，不让我过去，那么我就在这里，累了的时候，退后一步，回头看，我在这里。
为遇一人入红尘，人去我亦去，此生不留尘。
新时代，共享未来！
时光会把你雕刻成你应有的样子。
梦里与现实的距离，仅仅是双眸的一合一闭。
...
误会，不是始于说出的话。而且从言行本身开始，就已经在发生了
明明是个视观者，却以主角的观念活着！
山外青山楼外楼，西湖歌舞几时休？
黄粱一梦，山水万重，人间总相逢。
未期之遇，不告而别。闻所闻而来，见所见即去。
得来不易的机会，会让所有的动物去做原来不喜欢做的事。
可能我表述的太过明显，毕竟梦里常出现你的脸，他一遍一遍让我反复失眠，但这都不是重点，无解的是很多话我已藏了大半年。
给岁月以文明，而不是给文明以岁月。
...
春天马上就要来了，让我与你相遇的春天就要来了，再也没有你的春天就要来了
雪崩时，没有一片雪花是无辜的！
...
水滴撞碎的不仅仅是 2000 艘恒星级战舰，更是人类的骄傲自大的心。
...
不要随便贬低自己
火娃的熊熊烈焰，水娃的滔滔巨浪，当两种力量结合到一起的时候就变成了水蒸气
因为太害怕失去，所以才将苦痛剥离。
红豆生南国，春来发几枝。
...
今夜不知何处宿，平沙万里绝人烟。
永远都不要盲目跟风，因为你不知道风叫什么名字，它从哪里来，它将去往何处。
...
生命从无中来，到无中去，每个人都处于上场——谢幕这样一个循环中。这个循环不是悲伤，不是无意义，意义就在这过程中;生命之所以有趣，就在于过程中的体验和收获。
...
你知道雪花为什么是白色的吗？因为已经忘记自己本来是什么颜色啊。
...
自然选择号，前进四。
步伐虽小，密而不停
我确信你知道的，只有努力，才不会让自己轻易地被别人打倒或者看不起。
人终其一生都是自我改善的过程。
...
什么是死？是终点，是永诀，是不可挽回，是再也握不到的手、感觉不到的温度，再也说不出口的对不起。
负霜华，行世路。一同星尘，除魔歼邪
...
所谓大家，就是无视并牺牲了一部分弱势群体后所达到的虚伪的和平与共识。
夏雨微尘轻拂袖，两衫风雪若得闲。
沧海横流，方显英雄本色。
生活就像超级女生，走到最后的都是纯爷们。
现在永远是最坏的时候，永远期待美好的事情即将发生。
从开始的第一天起，就回不去了。
异地恋是，尝过欣喜若狂，也知道失魂落魄。
...
此后如竟没有炬火，我便是唯一的光。
世间万物，如果一直放着不管的话，便一定会向不好的方向发展。就像即使如何的努力也无法阻止宇宙变冷一样。只是按照常理进行不断积累而构筑出的世界，无论如何也无法脱离物理法则的束缚。
你的眼中，明暗交杂，一笑生花。
...
人是只要活在世上，就是必须背负某种罪孽的存在，正是这样，人只要活著就总会面对墙壁。重要的是要有跨越墙壁的意志。
故事不长，也不难讲，脸红相遇，红眼而离。
...
人一生会遇到约 2920 万人，两个人相爱的概率是 0.000049。所以你不爱我，我不怪你。
...
冲动的红色终究是败在了白玫瑰的平淡和冷静上，狠狠的跌了一个大跟头，看着更加刺眼。
多情只有春庭月，犹为离人照落花。
我还在原地等你，你却已经忘记来过这里
...
所有的梦境都是另一个现实，永远不要忘记。
很多人宁可否认事实，也不愿面对真相。
无论是钱，是名，还是其他的什么东西——只要他觉得有，他就会去做。哪怕是交易
我们的工作是搬运生命和死亡。
向来是据理力争，从不曾无理取闹。
不管对什么事情都不能有先入为主的观念。
肠已断，泪难收。相思重上小红楼。
